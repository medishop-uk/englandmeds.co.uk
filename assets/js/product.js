...
var REVIEW_API_URL=window.ENGLANDMEDS_DATA_API||'';
var REVIEW_SPREADSHEET_ID=window.ENGLANDMEDS_DATA_SPREADSHEET_ID||'';
var catalog={
...
'lorazepam-ativan-2-mg-e':['Lorazepam Ativan 2mg','Ativan','Verified manufacturer','Short-term anxiety',20],
...
function message(name,qty){return encodeURIComponent('Hello EnglandMeds, I would like to request '+name+'. Quantity: '+qty+'. Please confirm available packs, prescription requirements and delivery options.')}
...
function key(productSlug){return 'englandmedsReviews:'+productSlug}
...
function init(){
 ...
 var brand=field('Brand Name',article)||defaults[1],manufacturer=field('Manufacturer',article)||defaults[2],vendor=field('Vendor',article)||'EnglandMeds',category=field('Categories',article)||field('Category',article)||defaults[3];
